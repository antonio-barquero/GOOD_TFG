...
<div class="allcontain">
	<div class="feturedsection">
		<h1 style="color:#0000FF"class="text-center"><span >&bullet;</span>OFERTAS COCHES GAMA ALTA <span class="carstxt"></span>&bullet;</h1>
	</div>
	<div class="feturedimage">
		<div class="row firstrow">
			<div class="col-lg-6 costumcol colborder1">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img1colon">
						<img src="images/merche.jpg" alt="audi">
					</div>
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 txt1colon ">
						<div class="featurecontant">
							<h1>AUDI RS7</h1>
							<p>Año 2020 <br> 280 kms <br>
								Gasolina<br> 5 puertas<br> 421 cv <br>Manual  </p>
			 				<h2>Precio:  94.490 &euro;</h2>
			...
			<div class="col-lg-6 costumcol colborder1">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img1colon">
						<img src="images/PORCHE.JPG" alt="audi">
					</div>
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 txt1colon ">
						<div class="featurecontant">
							<h1>Porsche 911</h1>
							<p>Año 2014 <br> 18.000 kms <br>
								Gasolina<br> 3 puertas<br> 476 cv <br>Automático  </p>
			 				<h2>Precio:  113.490 &euro;</h2>
			 				<button id="btnRM" onclick="rmtxt()">CONTACTAR</button>
